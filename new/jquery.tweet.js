...
(function($) {
  $.fn.tweet = function(o){
    var s = $.extend({
      ...
      template: "{avatar}{join}{text}{time}",   // [string or function] template used to construct each tweet <li> - see code for available vars /* If we remove <br/> time display in straight line.*/
    ...
    function extract_template_data(item){
	  ...
	  o.time = t('<span class="tweet_time"><a href="{tweet_url}" title="view tweet on twitter">{tweet_relative_time}</a></span>', o);      o.text = t('<span class="tweet_text">{tweet_text_fancy}</span>', o);
    ...
    return this.each(function(i, widget){
      ...
      $(widget).bind("tweet:load", function(){
        $.getJSON(build_api_url(), function(data){
          ...
          list.append($.map(tweets, function(o) { return "<p>" + t(s.template, o) + "</p>"; }).join('')).
              children('p:first').addClass('tweet_first').end().
              children('p:odd').addClass('tweet_even').end().
              children('p:even').addClass('tweet_odd');
